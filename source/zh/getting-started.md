...
- **[QPython](qpython-x.md)** – 由 QPython 团队维护的主要版本，具备 AI 功能，可在 Google Play 等应用商店下载
- **[QPython+](qpython-x.md)** – 由开源贡献者推出的社区版，提供各种新特性
...
访问 [QPython.org](http://qpython.org) 获取文档、用户社区及帮助问答。
