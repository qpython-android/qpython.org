...
DATABASE_NAME = 'qpybook'             # Or path to database file if using sqlite3.
DATABASE_USER = 'root'             # Not used with sqlite3.
DATABASE_PASSWORD = 'md3qxwen'         # Not used with sqlite3.
DATABASE_HOST = ''             # Set to empty string for localhost. Not used with sqlite3.
DATABASE_PORT = ''             # Set to empty string for default. Not used with sqlite3.

#outgoing mail server settings
SERVER_EMAIL = 'Support'
DEFAULT_FROM_EMAIL = 'support@qpython.org'
EMAIL_HOST_USER = ''
EMAIL_HOST_PASSWORD = ''
EMAIL_SUBJECT_PREFIX = 'QPython support'
...
DOMAIN_NAME = 'qpython.org'

CSRF_COOKIE_NAME = 'qpy.zuowuxuxi.com_csrf'
#https://docs.djangoproject.com/en/1.3/ref/contrib/csrf/
#CSRF_COOKIE_DOMAIN = DOMAIN_NAME

#STATIC_ROOT = os.path.join(PROJECT_ROOT, "static")
ASKBOT_EXTRA_SKINS_DIR = os.path.join(PROJECT_ROOT,"skins")  #path to your private skin collection
STATICFILES_DIRS = (
